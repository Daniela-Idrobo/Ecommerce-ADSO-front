...
function FeaturedProducts() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4">
      <span className="tracking-tighter text-slate-800 dark:text-white text-[32px] sm:text-[60px]">
          ...
          result.map((product, index) => (
            ...
            >
              <img
                ...
                className="max-w-[300px] aspect-square w-full h-full object-cover rounded-lg"
              />
              <p className="text-lg mt-6 ml-4 font-semibold text-left text-gray-900">
                {product.productName}
              </p>
              <div className="flex items-center">
                <p className="px-4 py-1 m-4 border border-[#400f44] rounded-lg md:px-4 md:py-2 gap-2 hover:bg-[#c971df] md:text-sm">
                  {product.taste}
                </p>
                <p className="px-4 py-1 m-4 border border-[#400f44] rounded-lg md:px-4 md:py-2 gap-2 hover:bg-[#c971df] md:text-sm">
                  {product.origin}
